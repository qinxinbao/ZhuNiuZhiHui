...
- (id)initWithItems:(NSArray *)items withFrame:(CGRect)frame{
    if (self = [super initWithFrame:frame]) {
        ...
        self.backgroundColor = [UIColor colorWithRed:10 / 255.0 green:171 / 255.0 blue:255 / 255.0 alpha:1.0];
...
- (void)setUpItems:(NSArray *)items withSelectedColor:(UIColor *)selectedColor withNormolColor:(UIColor *)normolColor withFont:(UIFont *)font{
    ...
    for (NSInteger i = 0; i < items.count; i ++) {
        ...
        if (selectedColor == nil) {
            [button setTitleColor:[UIColor colorWithRed:10 / 255.0 green:171 / 255.0 blue:255 / 255.0 alpha:1.0] forState:UIControlStateNormal];
            button.backgroundColor = [UIColor colorWithRed:10 / 255.0 green:171 / 255.0 blue:255 / 255.0 alpha:1.0];
        }else{
    ...
    for (UIButton *otherButton in self.subviews) {
        if (otherButton == selectButton) {
            if (self.selectColor == nil) {
                selectButton.backgroundColor = [UIColor colorWithRed:10 / 255.0 green:171 / 255.0 blue:255 / 255.0 alpha:1.0];
            }else{
